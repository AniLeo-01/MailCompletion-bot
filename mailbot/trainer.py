...
if __name__ == "__main__":
    ...
    ap.add_argument('--logging_steps', required=False, help='logging steps')
    ...
    ap.add_argument('--weight_decay', required=False, help='weight decay')
    ap.add_argument('--monitoring_platform', required=True, help='monitoring platform')
